# Wdrożenie ZapisyPro na home.pl
...
Poniżej skrócona wersja z różnicami specyficznymi dla ZapisyPro.
...
Wgraj **całą zawartość folderu `zapisypro/php/`** (nie cały folder `zapisypro`,
