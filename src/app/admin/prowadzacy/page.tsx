...
import { createInstructorAction } from "@/lib/actions/admin-actions";
  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="mt-1 text-[var(--muted)]">
        Jako właściciel pracowni (master admin) możesz zakładać konta prowadzącym — po
        zalogowaniu każdy prowadzący sam dodaje swój grafik w{" "}
      ...
      <div className="mt-8 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6">
        ...
        <p className="mt-1 text-sm text-[var(--muted)]">
          Ustaw hasło startowe i przekaż je prowadzącemu — może je potem zmienić samodzielnie
          (funkcja zmiany hasła: do dodania w razie potrzeby).
        </p>
        <form action={createInstructorAction} className="mt-4 grid gap-4 sm:grid-cols-2">
          <div>
