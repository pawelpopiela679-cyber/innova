...
function render_logo(string $size = 'md'): string
{
    ...
    if (is_file(__DIR__ . '/../logo.png')) {
        ...
        return '<span class="logo ' . $sizeClass . '"><img src="' . $src . '" alt="ZapisyPro" style="height:' . $height . 'px;width:auto;"></span>';
    }

    return '<span class="logo ' . $sizeClass . '"><span class="logo-mark">Z</span><span class="logo-word">apisy<b>Pro</b></span></span>';
}
