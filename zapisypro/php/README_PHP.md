# ZapisyPro — wersja PHP (multi-tenant SaaS)
...
| Wygląd | oliwkowo-beżowy, Fredoka/Caveat | indygo/koral, Sora/Inter, animacje (kalendarz, liczniki, karty) |

## Role

- **SUPER_ADMIN** — Ty, właściciel platformy ZapisyPro. Widzi wszystkie
...
- **Własne subdomeny per organizacja** (np. `demo-szkola.zapisypro.pl`) —
...
- Funkcje, które INNOVA ma, a ZapisyPro v1 celowo pominęła, żeby dowieźć
