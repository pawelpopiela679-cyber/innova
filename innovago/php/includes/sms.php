 ...
 * Vercom). InnovaGo sam nie ma umowy z żadnym dostawcą (to wymaga Twojego
...
function send_sms(string $phone, string $message): void
{
    ...
    //   curl_close($ch);
    error_log('[InnovaGo] SMS_API_TOKEN ustawiony, ale integracja z bramką nie jest jeszcze podpięta w includes/sms.php.');
}
