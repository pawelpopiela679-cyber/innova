...
<title>Instalacja — ZapisyPro</title>
<style>
  body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;max-width:720px;margin:40px auto;padding:0 20px;line-height:1.6;color:#1b2340;background:#f4f6fb}
  .card{background:#fff;border:1px solid #e2e7f5;border-radius:16px;padding:24px;margin-bottom:20px;box-shadow:0 4px 20px rgba(30,41,90,.05)}
  h1{margin-top:0}
  code{background:#eef0fa;padding:2px 6px;border-radius:4px}
  pre{background:#1b2340;color:#eef0fa;padding:16px;border-radius:10px;overflow-x:auto;white-space:pre-wrap}
  .ok{color:#1f9d55;font-weight:bold}
  .err{color:#d64545;font-weight:bold}
  button{background:#4338ca;color:#fff;border:none;border-radius:999px;padding:12px 24px;font-weight:bold;font-size:1rem;cursor:pointer}
  button:hover{opacity:.9}
  .warn{background:#fff4ec;border:1px solid #f3c89a;color:#92400e;border-radius:10px;padding:12px 16px}
</style>
</head>
<body>
<h1>Instalacja ZapisyPro</h1>
