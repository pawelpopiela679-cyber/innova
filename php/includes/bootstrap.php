...
// Sesja logowania — własna nazwa ciasteczka (żeby nie kolidowało z inną
// aplikacją PHP w tym samym katalogu na hostingu), httpOnly, SameSite=Lax.
session_name('innova_session');
