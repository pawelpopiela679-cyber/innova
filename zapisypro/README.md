# ZapisyPro — drugi projekt w tym repo
...
Ten katalog jest **niezależny od `INNOVA`** (Next.js w roocie repo + `../php`)
— to osobny projekt w tym samym repozytorium (patrz Twoje pytanie o
"2 projekty w jednym repo": tak, tak to wygląda w praktyce).
...
## Co odróżnia ZapisyPro od INNOVA

INNOVA to appka **jednej pracowni**. ZapisyPro to **produkt, który
...
- Nowy, spójny, animowany interfejs (indygo/koral, Sora/Inter) — patrz
  `preview/` dla szybkiego podglądu bez instalowania czegokolwiek.
