...
<div class="nb-cards mt-8" style="grid-template-columns:repeat(3,1fr);">
  <div class="nb-card" style="background:#cfe6f7; cursor:default;">
    ...
    <?php $kontaktPhone = get_content('footer.phone_number', '790 250 363'); ?>
    <p><a href="tel:+48<?= e(preg_replace('/[^0-9]/', '', $kontaktPhone)) ?>" style="color:inherit; text-decoration:underline;"><?= e($kontaktPhone) ?></a></p>
  </div>
  ...
  <div class="nb-card" style="background:#faedc4; cursor:default;">
    ...
    <p><?= e(get_content('footer.address_text', 'ul. Kolejowa, Czechowice-Dziedzice')) ?></p>
  </div>
</div>
